...
public class CreatureWorld extends World
{
    ...
    {
        addObject(creaturePlayerOne,creaturePlayerOne.getImage().getWidth()/2,getHeight() - creaturePlayerOne.getImage().getHeight()/2);
        addObject(new Button(Color.RED,50),getWidth()/2, getHeight()-100);
        
        addObject(creaturePlayerTwo, getWidth() - creaturePlayerTwo.getImage().getWidth()/2,creaturePlayerTwo.getImage().getHeight()/2);
